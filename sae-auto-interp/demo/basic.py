...
import sys
sys.path.append("/home/xuzhen/switch_sae/sae-auto-interp")
...
def main(args):
    ...
    ### Load tokens ###
    tokenizer = load_tokenizer("/home/xuzhen/switch_sae/gpt2")
    tokens = load_tokenized_data(
        args.feature.example_ctx_len,
        tokenizer,
        "/home/xuzhen/switch_sae/sae-auto-interp/openwebtext2-first-30-chunks-translation-examples",
        "train[:15%]",
    )
