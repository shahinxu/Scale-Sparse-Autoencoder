...
from dictionary_learning.trainers.switch import MultiExpertAutoEncoder, MoETrainer
...
trainer_configs = [(base_trainer_config | {'k': combo[0], 'experts': combo[1], 'e': 1, 'heaviside': combo[2]}) for combo in itertools.product(args.ks, args.num_experts, args.heavisides)]
