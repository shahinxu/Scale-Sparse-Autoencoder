...
def draw_legend_with_frame():
    ...
    # 颜色代码根据原图进行了微调，使其更接近
    legend_config = [
        {'label': 'Scale SAE, act=8', 'color': colors[0], 'marker': markers[0], 'size': 26},
        {'label': 'Scale SAE, act=4', 'color': colors[1], 'marker': markers[1], 'size': 26},
        {'label': 'Scale SAE, act=2', 'color': colors[2], 'marker': markers[2], 'size': 26},
