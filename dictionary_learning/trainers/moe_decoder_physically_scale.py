...
class Expert(nn.Module):
    def __init__(self, input_dim, output_dim):
        super().__init__()        
        self.decoder = nn.Parameter(t.empty(output_dim, input_dim))
...
class MultiDecScaleAutoEncoder(nn.Module):
    ...
    def from_pretrained(path, k=100, experts=16, e=1, heaviside=False, device=None
        ...
        autoencoder = MultiDecScaleAutoEncoder(activation_dim, dict_size, k, experts, e, heaviside)
