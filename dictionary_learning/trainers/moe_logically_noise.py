...
class NoiseAutoEncoder(Dictionary, nn.Module):
    """
    ...
    def from_pretrained(path, k=100, experts=16, e=1, heaviside=False, device=None):
        ...
        autoencoder = NoiseAutoEncoder(activation_dim, dict_size, k, experts, e, heaviside)
