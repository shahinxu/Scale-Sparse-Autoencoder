...
class MultiExpertSimpleScaleAutoEncoder(nn.Module):
    ...
    def from_pretrained(path, k=100, experts=16, e=1, heaviside=False, device=None
        ...
        autoencoder = MultiExpertSimpleScaleAutoEncoder(activation_dim, dict_size, k, experts, e, heaviside)
...
class MoETrainer(SAETrainer):
    ...
    """
    def __init__(self,
                 dict_class=MultiExpertSimpleScaleAutoEncoder,
                 activation_dim=512,
                 dict_size=64*512,
                 k=100,
                 experts=16,
